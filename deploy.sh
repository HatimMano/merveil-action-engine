...
#     PAS poussé à Duve — la RC valide puis l'envoie. Critères : last-minute
#     (ISEO_HOLD_LEAD_HOURS, tous canaux) + rien d'encaissé sur le canal DIRECT seul.
